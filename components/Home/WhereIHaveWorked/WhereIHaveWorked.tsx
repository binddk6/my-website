...
export default function WhereIHaveWorked() {
  const GetDescription = () => {
    switch (DescriptionJob) {
      ...
      case "SmartSense":
        return <SmartSenseDescription />;
      default:
        return null;
    }
  };

  const [DescriptionJob, setDescriptionJob] = React.useState("TCS");
...
const CompaniesBar = (props) => {
  ...
  return (
    ...
    >
      {/* Left bar Holder */}
      <div
        className="hidden md:block bg-gray-500 relative h-0.5 w-34 md:h-[200px] translate-y-1 md:w-0.5  
      ...
      <div className="flex flex-col md:order-2 order-1 space-y-1 pl-8 md:pl-0">
        <div className="flex flex-row md:flex-col">
          ...
          <CompanyButton
            ...
            CompanyName="SmartSense"
            BarPosition={40}
            BarAbovePosition={129}
            DescriptionJob="SmartSense"
